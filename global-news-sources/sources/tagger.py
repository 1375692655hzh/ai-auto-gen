...
_T = {
    # 美股·科技/半导体/算力
    "NVDA": ("NVDA", "美国", "AI与算力>AI芯片"), "英伟达": ("NVDA", "美国", "AI与算力>AI芯片"),
    "NVIDIA": ("NVDA", "美国", "AI与算力>AI芯片"),
    "AMD": ("AMD", "美国", "AI与算力>AI芯片"),
    "AVGO": ("AVGO", "美国", "半导体>IC设计与EDA"), "博通": ("AVGO", "美国", "半导体>IC设计与EDA"),
    "TSM": ("TSM", "美国", "半导体>代工"),
    "INTC": ("INTC", "美国", "半导体>IC设计与EDA"), "英特尔": ("INTC", "美国", "半导体>IC设计与EDA"),
    "QCOM": ("QCOM", "美国", "半导体>IC设计与EDA"), "高通": ("QCOM", "美国", "半导体>IC设计与EDA"),
    "MU": ("MU", "美国", "半导体>存储记忆体"), "美光": ("MU", "美国", "半导体>存储记忆体"),
    "ASML": ("ASML", "美国", "半导体>设备材料"),
    "AMAT": ("AMAT", "美国", "半导体>设备材料"), "应用材料": ("AMAT", "美国", "半导体>设备材料"),
    "ARM": ("ARM", "美国", "半导体>IC设计与EDA"),
    "SMCI": ("SMCI", "美国", "AI与算力>服务器与ODM"), "超微电脑": ("SMCI", "美国", "AI与算力>服务器与ODM"),
    "AAPL": ("AAPL", "美国", "消费电子>苹果链"), "苹果": ("AAPL", "美国", "消费电子>苹果链"),
    "MSFT": ("MSFT", "美国", "互联网与传媒>云与SaaS"), "微软": ("MSFT", "美国", "互联网与传媒>云与SaaS"),
    "GOOGL": ("GOOGL", "美国", "互联网与传媒>社交广告"), "谷歌": ("GOOGL", "美国", "互联网与传媒>社交广告"),
    "AMZN": ("AMZN", "美国", "互联网与传媒>电商"), "亚马逊": ("AMZN", "美国", "互联网与传媒>电商"),
    "META": ("META", "美国", "互联网与传媒>社交广告"),
    "NFLX": ("NFLX", "美国", "互联网与传媒>游戏"), "奈飞": ("NFLX", "美国", "互联网与传媒>游戏"),
    "TSLA": ("TSLA", "美国", "汽车与智能驾驶>整车"), "特斯拉": ("TSLA", "美国", "汽车与智能驾驶>整车"),
    "PLTR": ("PLTR", "美国", "互联网与传媒>云与SaaS"),
    "COIN": ("COIN", "美国", "金融与加密>加密资产"),
    "MSTR": ("MSTR", "美国", "金融与加密>加密资产"),
    "JPM": ("JPM", "美国", "金融与加密>银行"), "摩根大通": ("JPM", "美国", "金融与加密>银行"),
    "GS": ("GS", "美国", "金融与加密>券商"), "高盛": ("GS", "美国", "金融与加密>券商"),
    "XOM": ("XOM", "美国", "油气与能源>油气开采"), "埃克森美孚": ("XOM", "美国", "油气与能源>油气开采"),
    "LLY": ("LLY", "美国", "医药生物>创新药"), "礼来": ("LLY", "美国", "医药生物>创新药"),
    "NVO": ("NVO", "美国", "医药生物>创新药"), "诺和诺德": ("NVO", "美国", "医药生物>创新药"),
    "BA": ("BA", "美国", "军工与航空航天>航空制造"), "波音": ("BA", "美国", "军工与航空航天>航空制造"),
    "DIS": ("DIS", "美国", "互联网与传媒>游戏"), "迪士尼": ("DIS", "美国", "互联网与传媒>游戏"),
    # A股
    ...
    # 港股
    "0700": ("0700.HK", "香港", "互联网与传媒>社交广告"), "腾讯": ("0700.HK", "香港", "互联网与传媒>社交广告"),
    "騰訊": ("0700.HK", "香港", "互联网与传媒>社交广告"),
    "9988": ("9988.HK", "香港", "互联网与传媒>电商"), "阿里巴巴": ("9988.HK", "香港", "互联网与传媒>电商"),
    "3690": ("3690.HK", "香港", "消费>零售电商"), "美团": ("3690.HK", "香港", "消费>零售电商"),
    "9618": ("9618.HK", "香港", "互联网与传媒>电商"), "京东": ("9618.HK", "香港", "互联网与传媒>电商"),
    "京東": ("9618.HK", "香港", "互联网与传媒>电商"),
    "1810": ("1810.HK", "香港", "消费电子>安卓链"), "小米": ("1810.HK", "香港", "消费电子>安卓链"),
    "1211": ("1211.HK", "香港", "汽车与智能驾驶>整车"), "比亚迪股份": ("1211.HK", "香港", "汽车与智能驾驶>整车"),
    "0941": ("0941.HK", "香港", "通信与卫星>运营商"), "中国移动": ("0941.HK", "香港", "通信与卫星>运营商"),
    # ── 英文公司名别名(2026-09-09 补: 英文产业链文本打标失明修复) ─────────────
    # ASCII 通道词边界+大小写敏感, 只认首字母大写的专名形态, 普通词(apple/meta 小写)不伤;
    # 全部复用既有(代码,市场,赛道)值域, _self_check 兜底。
    "Nvidia": ("NVDA", "美国", "AI与算力>AI芯片"),
    "Google": ("GOOGL", "美国", "互联网与传媒>社交广告"),
    "Alphabet": ("GOOGL", "美国", "互联网与传媒>社交广告"),
    "Microsoft": ("MSFT", "美国", "互联网与传媒>云与SaaS"),
    "Apple": ("AAPL", "美国", "消费电子>苹果链"),
    "Amazon": ("AMZN", "美国", "互联网与传媒>电商"),
    "Meta": ("META", "美国", "互联网与传媒>社交广告"),
    "Tesla": ("TSLA", "美国", "汽车与智能驾驶>整车"),
    "Broadcom": ("AVGO", "美国", "半导体>IC设计与EDA"),
    "Intel": ("INTC", "美国", "半导体>IC设计与EDA"),
    "Micron": ("MU", "美国", "半导体>存储记忆体"),
    "Qualcomm": ("QCOM", "美国", "半导体>IC设计与EDA"),
    "Netflix": ("NFLX", "美国", "互联网与传媒>游戏"),
    "Disney": ("DIS", "美国", "互联网与传媒>游戏"),
    "Boeing": ("BA", "美国", "军工与航空航天>航空制造"),
    "JPMorgan": ("JPM", "美国", "金融与加密>银行"),
    "Goldman Sachs": ("GS", "美国", "金融与加密>券商"), "Goldman": ("GS", "美国", "金融与加密>券商"),
    "Palantir": ("PLTR", "美国", "互联网与传媒>云与SaaS"),
    "Coinbase": ("COIN", "美国", "金融与加密>加密资产"),
    "MicroStrategy": ("MSTR", "美国", "金融与加密>加密资产"),
    "Eli Lilly": ("LLY", "美国", "医药生物>创新药"),
    "Novo Nordisk": ("NVO", "美国", "医药生物>创新药"),
    "ExxonMobil": ("XOM", "美国", "油气与能源>油气开采"), "Exxon": ("XOM", "美国", "油气与能源>油气开采"),
    "Supermicro": ("SMCI", "美国", "AI与算力>服务器与ODM"), "Super Micro": ("SMCI", "美国", "AI与算力>服务器与ODM"),
    "TSMC": ("2330.TW", "台湾", "半导体>代工"),
    "Foxconn": ("2317.TW", "台湾", "AI与算力>服务器与ODM"),
    "MediaTek": ("2454.TW", "台湾", "半导体>IC设计与EDA"),
    "Tencent": ("0700.HK", "香港", "互联网与传媒>社交广告"),
    "Alibaba": ("9988.HK", "香港", "互联网与传媒>电商"),
    "Meituan": ("3690.HK", "香港", "消费>零售电商"),
    "Xiaomi": ("1810.HK", "香港", "消费电子>安卓链"),
    "BYD": ("002594.SZ", "A股", "汽车与智能驾驶>整车"),
    "CATL": ("300750.SZ", "A股", "新能源与电力>储能"),
    "SMIC": ("688981.SH", "A股", "半导体>代工"),
}
...
_EVENT = [
    ...
    ("rating",   r"评级|目标价|upgrade|downgrade|outperform|underperform|price target|增持评级|减持评级"),
    ("mna",      r"并购|收购|合并|要约|merger|acquisition|acquires\b|takeover|私有化"),
    ...
    ("contract", r"中标|签约|大单|合同额|framework agreement|contract|订单|supply (deal|agreement)|purchase agreement"),
    ("personnel", r"辞职|卸任|任命|升任|高管变动|resigns|appoints|new CEO"),
    ("product",  r"发布会|新品|上线|launch|unveil|正式发布|benchmark|perf(ormance)? per (dollar|watt)|open-?sourc|tape-?out|流片|量产|mass production|rolls? out"),
]
...
def _self_check() -> None:
    """词典值域对照 taxonomy 单一真相(2026-09-03): 漂移在 import 时直接报错。"""
    from sources.taxonomy import MARKETS, L1_L2
    for alias, (code, mk, sec) in _T.items():
        assert mk in MARKETS, f"ticker词典市场非法: {alias} -> {mk}"
        if sec:
            l1, _, l2 = sec.partition(">")
            assert l1 in L1_L2, f"ticker词典L1非法: {alias} -> {sec}"
            assert l2 in L1_L2[l1], f"ticker词典L2非法: {alias} -> {sec}"
...
def enrich(text: str, kind: str = "") -> dict:
    """对单条文本打标。返回 {tickers, event_type, sentiment, sectors, markets, matched_terms}。

    markets = ticker 词典命中的市场(新枚举), 供 store 与源继承市场做并集(2026-09-03)。
    """
    out = {"tickers": [], "event_type": "", "sentiment": "", "sectors": [],
           "markets": [], "matched_terms": []}
    if not text:
        return out
    seen_codes = set()
    for alias, rx in _ASCII_RE:                       # 英文别名: 词边界匹配
        ...
        if rx.search(text):
            ...
            if code not in seen_codes:
                ...
                if mk and mk not in out["markets"]:
                    out["markets"].append(mk)
