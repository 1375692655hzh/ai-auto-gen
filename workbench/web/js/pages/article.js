...
WB.pages.article = {
  ...
  <div>
          ...
          <div class="surge-grid">
            ...
            <div class="surge-body">
              ...
              <div v-if="xLong(r)" class="x-expand">
                <span class="act" @click="xToggle(r)">{{ xExpanded[r.status_id] ? '收起' : '展开全文' }}</span>
              </div>
    ...
    <div v-show="tab==='surge'" class="surge-layout">
          ...
          <div class="surge-grid">
            ...
            <div class="surge-body">
              ...
              <div class="news-actions blocks">
                ...
                <span v-if="basketIds[r.status_id]" class="act-done">已加入 ✓</span>
                <span v-else class="act" @click="addXToPool(r)">加入素材</span>
                <span class="act gen" @click="genReply(r)">评论生成</span>
              </div>
