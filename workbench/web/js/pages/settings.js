  ...
  <div style="max-width:760px">
    ...
    <div class="card" v-show="sec==='translate'">
      ...
      <div class="key-guide">
        ...
        强制走代理+香港出口仍 403, 疑似按账号/渠道地区绑定)。
        <b>不想开 TUN 的替代(2026-09-10 实证): OmniRoute 面板(127.0.0.1:20128)→
        opencode 免费账号卡→账号代理, 填本机 Clash 的 HTTP 端口(如 http://127.0.0.1:7897,
        节点须美国)——OmniRoute 对该账号的整条请求链(含中转)走它自带的 ProxyAgent,
        无泄漏、不依赖 TUN/系统代理。</b>注意: 代理端口没在监听时会静默回落直连(又 403),
        确认 Clash 开着且该端口能出美国。嫌麻烦就配上面的 DeepSeek。<br>
