  ...
  <div style="max-width:760px">
    ...
    <div class="card" v-show="sec==='translate'">
      ...
      <div class="key-guide">
        ...
        "整体干净的非大陆出口", 两选一:<br>
        <b>【方式 A · 开 TUN(最省事)】</b> Clash Verge 开 TUN 模式 + 美国节点,
        网络层全接管无泄漏, 免费位即装即用; 代价是全局流量都过代理。<br>
        <b>【方式 B · 不开 TUN, 只代理 OmniRoute 自己(一次性配置)】</b>
        机制已从 OmniRoute 源码确认: 免费位账号可挂独立代理, 整条请求链(含中转)
        走它自带的 ProxyAgent, 无泄漏, 系统其它流量完全不受影响。步骤:<br>
        ① Clash 保持运行, 确认 HTTP 混合端口(Verge 默认 7897)在监听,
           规则能让目标域名走<b>美国</b>节点(最稳=全局模式+美国节点);
           不用开 TUN、不用开系统代理。<br>
