...
where py >nul 2>nul && (start "" /b cmd /c "py -3.11 cli.py sources serve >> data\serve_task.log 2>&1") || (start "" /b cmd /c "python cli.py sources serve >> data\serve_task.log 2>&1")
exit /b 0
